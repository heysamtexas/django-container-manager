...
class JobManagementServiceCoreTest(TestCase):
    ...
    def test_job_validation_success(self):
        ...
        with patch.object(self.service.executor_factory, 'get_executor') as mock_executor_factory:
            mock_executor = Mock()
...
class ModuleLevelServiceFunctionsTest(TestCase):
    ...
    def test_module_level_launch_job(self, mock_service):
        ...
        mock_service.launch_job.return_value = {'success': True, 'execution_id': 'module-123'}
