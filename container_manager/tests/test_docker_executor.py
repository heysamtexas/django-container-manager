...
from container_manager.models import ContainerJob, ContainerTemplate, ExecutorHost, ContainerExecution
from container_manager.executors.docker import DockerExecutor
from container_manager.executors.exceptions import ExecutorConnectionError, ExecutorError
...
class DockerExecutorTest(TestCase):
    ...
    def test_split_docker_logs_case_insensitive(self):
        ...
        self.assertEqual(stdout, "Normal line")
        self.assertEqual(stderr, "error: lowercase error\nException occurred\ntraceback here")
    ...
    def test_build_labels(self):
        ...
        self.assertEqual(labels["django.container_manager.template_name"], self.template.name)
