...
from ..services import launch_job, check_job_status, harvest_job_results
...
class JobServiceIntegrationTest(TestCase):
    ...
    def test_launch_job_service_integration(self):
        ...
        with patch('container_manager.executors.mock.MockExecutor.launch_job') as mock_launch:
    ...
    def test_check_job_status_integration(self):
        ...
        with patch('container_manager.executors.mock.MockExecutor.check_status') as mock_check:
    ...
    def test_harvest_job_results_integration(self):
        ...
        with patch('container_manager.executors.mock.MockExecutor.harvest_job') as mock_harvest:
    ...
    def test_queue_batch_launch_integration(self):
        ...
        with patch('container_manager.executors.mock.MockExecutor.launch_job') as mock_launch:
            ...
            for job in jobs:
                ...
                self.assertEqual(job.get_execution_identifier(), f'mock-execution-{job.id}')
...
class JobLifecycleIntegrationTest(TestCase):
    ...
    def test_complete_job_lifecycle(self):
        ...
        with patch('container_manager.executors.mock.MockExecutor.launch_job') as mock_launch:
            ...
            self.job.refresh_from_db()
            self.assertEqual(self.job.status, 'running')
            self.assertEqual(self.job.get_execution_identifier(), 'lifecycle-execution-123')
        
        # Step 3: Check job status
        with patch('container_manager.executors.mock.MockExecutor.check_status') as mock_status:
